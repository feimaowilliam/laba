...
var manifest = {
    packageUrl: 'http://47.105.168.156/flymGames/laBa9/remote-assets/',
    remoteManifestUrl: 'http://47.105.168.156/flymGames/laBa9/remote-assets/project.manifest',
    remoteVersionUrl: 'http://47.105.168.156/flymGames/laBa9/remote-assets/version.manifest',
    version: '1.0.14',
    sizes: {},
    files: {},
    assets: {},
...
function traverseDir() {
    ...
    var subPaths = fs.readdirSync(oldPath),
        subPath, versionPaths, oldVersion, oldVersionPath;
